  ...
  return (
    <section className="py-20 px-6 relative overflow-hidden bg-secondary/60">
      ...
      <div className="absolute inset-0">
        <div className="absolute top-0 left-1/3 w-72 h-72 bg-primary/20 rounded-full blur-3xl"></div>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            {values.map((value, index) => (
              <motion.div
                key={index}
                className="glass-effect rounded-2xl p-6 border border-dark-border/60 hover:border-primary/40 transition-all duration-300 group"
              ...
              >
                <div className="flex items-start gap-4">
                  <motion.div
                    className="w-12 h-12 bg-gradient-to-br from-primary/25 to-primary-dark/25 rounded-xl flex items-center justify-center group-hover:shadow-primary transition-all duration-300 flex-shrink-0"
