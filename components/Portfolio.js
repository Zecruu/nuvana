            ...
            >
              ...
              <div className="flex gap-3">
                <motion.a
                  ...
                  className="flex-1 bg-gradient-to-r from-primary to-secondary text-white font-semibold py-3 px-6 rounded-lg flex items-center justify-center gap-2 hover:shadow-primary transition-all"
                ...
                <motion.button
                  className="px-6 py-3 border border-primary/30 text-primary rounded-lg hover:bg-primary/10 transition-all"
                  whileHover={{ scale: 1.02 }}
                  whileTap={{ scale: 0.98 }}
                >
                  Case Study
